...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/product-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 21:40:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>::eBazar::  Shopping Cart </title>
                    ...
                    <li class="collapsed">
                        <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu-product" href="#">
                            ...
                            <ul class="sub-menu collapse show" id="menu-product">
                                ...
                                <li><a class="ms-link active" href="product-cart.html">Shopping Cart</a></li>
