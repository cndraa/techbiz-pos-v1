...
<head>
    ...
    <title>::eBazar::  Order Invoice </title>
        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu-order" href="#">
                        ...
                        <ul class="sub-menu collapse show" id="menu-order">
                            ...
                            <li><a class="ms-link active" href="order-invoices.html">Order Invoices</a></li>
                        </ul>
                    </li>
                    <li class="collapsed">
...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/order-invoices.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 21:40:58 GMT -->
</html> 