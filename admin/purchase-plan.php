...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/purchase-plan.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Mar 2023 21:41:20 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>::eBazar:: Purchase Plan </title>
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#categories" href="#">
                            ...
                            <ul class="sub-menu collapse" id="categories">
                                <li><a class="ms-link" href="product-grid.php">Categories List</a></li>
                                <li><a class="ms-link" href="product-list.php">Categories Edit</a></li>
                            </ul>
                    </li>
                    <li class="collapsed">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse show" id="page">
                            ...
                            <li><a class="ms-link active" href="purchase-plan.html">Price Plan Example</a></li>
