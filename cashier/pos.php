                           ...
                           <div class="row mt-2">
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="customer_name" class="form-control form-control-lg" id="guest_name" placeholder="Enter Customer Name here...">
                                 </div>
                              </div>
                              <div class="col-md-6 mb-3">
                                 <div class="form-group">
         ...
         $.post("../app/View",fData,function(data){
          ...
          $(".addMoreBtn").on("click",function(){
           ...
           $.ajax({
              ...
              <td><input class="form-control form-control-lg product_total" readonly style="width:120px" type="number" id="product_total" name="product_total[]" value="${response.selling_price*1}" required></td>
